...
bool TutorialScene::init() {
  ...
  // Tutorial script
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Hi!\nYou have to clear these blocks.", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "It's made of blocks you can move horizontally.", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(1.0f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Slide horizontally with your finger to move them.", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.5f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new CursorAction(.5f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new CursorAction(.5f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new CursorAction(.5f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new CursorAction(.5f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  ...
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "You can make them fall to fill in holes.", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::BLOCK_SWITCH)));

  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Align 3 blocks horizontally or vertically...", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.5f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.5f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "... to clear them.", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new CursorAction(.05f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  ...
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "If you slide vertically with your finger.", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "It raises the stack.", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.1f, tutorialPlayer, MoveType::LIFT)));
  script.add(std::unique_ptr<Action>(new PauseAction(.5f)));
  script.add(std::unique_ptr<Action>(new CursorAction(.1f, tutorialPlayer, MoveType::LIFT)));
  script.add(std::unique_ptr<Action>(new PauseAction(.5f)));
  script.add(std::unique_ptr<Action>(new CursorAction(.1f, tutorialPlayer, MoveType::LIFT)));
  script.add(std::unique_ptr<Action>(new PauseAction(.5f)));
  script.add(std::unique_ptr<Action>(new CursorAction(.1f, tutorialPlayer, MoveType::LIFT)));
  script.add(std::unique_ptr<Action>(new PauseAction(.5f)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Don't raise it too much though, or ...", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.1f, tutorialPlayer, MoveType::LIFT)));
  script.add(std::unique_ptr<Action>(new PauseAction(.5f)));
  script.add(std::unique_ptr<Action>(new CursorAction(.1f, tutorialPlayer, MoveType::LIFT)));
  script.add(std::unique_ptr<Action>(new PauseAction(.5f)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "... blocks start panicking ...", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.1f, tutorialPlayer, MoveType::LIFT)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "... and eventually the game is over.", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(2)));

  script.add(std::unique_ptr<Action>(new SetBlocksAction(1, tutorialPanel, empty)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Now let's have a look at combos and chains.", textToType)));
  script.add(std::unique_ptr<Action>(new SetBlocksAction(1, tutorialPanel, combo4and5)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "A combo is triggered when you clear at least 4 blocks.", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Clear 4!", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Clear 5!", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(2)));
  script.add(std::unique_ptr<Action>(new SetBlocksAction(0.01f, tutorialPanel, combo6and10)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_LEFT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Clear 6!", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_RIGHT)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_UP)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Clear 10!", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(2)));

  script.add(std::unique_ptr<Action>(new SetBlocksAction(1, tutorialPanel, empty)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Now on to chains.", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new SetBlocksAction(0.01f, tutorialPanel, chainx2)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Chains are triggered when a clearing is done with blocks ...", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "... falling from a previous clearing.", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Chain x2", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::CURSOR_DOWN)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new PauseAction(4)));
  script.add(std::unique_ptr<Action>(new SetBlocksAction(0.01f, tutorialPanel, chainx3)));
  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "Chain x3", textToType)));
  script.add(std::unique_ptr<Action>(new CursorAction(.02f, tutorialPlayer, MoveType::BLOCK_SWITCH)));
  script.add(std::unique_ptr<Action>(new PauseAction(5)));

  script.add(std::unique_ptr<Action>(new TypeTextAction(.1f, "This closes the tutorial.\nGo play to practice!", textToType)));
  script.add(std::unique_ptr<Action>(new PauseAction(1)));
