...
CCSpriteFrame *AbstractPanelScene::getBlockFrame(Block *blockSituation, int64_t tick, bool compressed, bool panicking) {
...
inline std::string AbstractPanelScene::format(const char *fmt, ...) {
  size_t size = 512;
  char *buffer = 0;
