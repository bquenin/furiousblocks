...
public interface GraphObject {
  ...
  final class Factory {
    ...
    private static <T extends GraphObject> T createGraphObjectProxy(Class<T> graphObjectClass, JSONObject state) {
      ...
      @SuppressWarnings("unchecked") T graphObject = (T) Proxy.newProxyInstance(GraphObject.class.getClassLoader(), interfaces, graphObjectProxy);
    ...
    private static Map<String, Object> createGraphObjectProxyForMap(JSONObject state) {
      ...
      @SuppressWarnings("unchecked") Map<String, Object> graphObject = (Map<String, Object>) Proxy.newProxyInstance(GraphObject.class.getClassLoader(), interfaces, graphObjectProxy);
    ...
    static <U> U coerceValueToExpectedType(Object value, Class<U> expectedType, ParameterizedType expectedTypeAsParameterizedType) {
      ...
      if (GraphObject.class.isAssignableFrom(expectedType)) {
        @SuppressWarnings("unchecked") Class<? extends GraphObject> graphObjectClass = (Class<? extends GraphObject>) expectedType;
        ...
        if (JSONObject.class.isAssignableFrom(valueType)) {
          ...
          @SuppressWarnings("unchecked") U result = (U) createGraphObjectProxy(graphObjectClass, (JSONObject) value);
          return result;
          ...
          @SuppressWarnings("unchecked") U result = (U) ((GraphObject) value).cast(graphObjectClass);
          return result;
        } else {
        ...
        if (JSONArray.class.isAssignableFrom(valueType)) {
          ...
          @SuppressWarnings("unchecked") U result = (U) createList(jsonArray, collectionGenericArgument);
          return result;
        } else {
    ...
    private final static class GraphObjectProxy extends ProxyBase<JSONObject> {
      ...
      private final Object proxyMapMethods(Method method, Object[] args) {
        ...
        if (methodName.equals(CLEAR_METHOD)) {
          ...
          if (args[0] instanceof Map<?, ?>) {
            @SuppressWarnings("unchecked") Map<String, Object> castMap = (Map<String, Object>) args[0];
            map = castMap;
      ...
      private final Object proxyGraphObjectMethods(Object proxy, Method method, Object[] args) {
        ...
        if (methodName.equals(CAST_METHOD)) {
          @SuppressWarnings("unchecked") Class<? extends GraphObject> graphObjectClass = (Class<? extends GraphObject>) args[0];
      ...
      private final Object proxyGraphObjectGettersAndSetters(Method method, Object[] args) throws JSONException {
        ...
        String key = propertyNameOverride != null ? propertyNameOverride.value() : convertCamelCaseToLowercaseWithUnderscores(methodName.substring(3));
