...
public class Session implements Serializable {
  ...
  public String toString() {
    return new StringBuilder().append("{Session").append(" state:").append(this.state).append(", token:").append((this.tokenInfo == null) ? "null" : this.tokenInfo).append(", appId:").append((this.applicationId == null) ? "null" : this.applicationId).append("}").toString();
  }
  ...
  class TokenRefreshRequest implements ServiceConnection {
    ...
    public void bind() {
      ...
      if (intent != null && staticContext.bindService(intent, new TokenRefreshRequest(), Context.BIND_AUTO_CREATE)) {
  ...
  public static class AuthorizationRequest implements Serializable {
    ...
    AuthorizationClient.AuthorizationRequest getAuthorizationClientRequest() {
      ...
      return new AuthorizationClient.AuthorizationRequest(loginBehavior, requestCode, isLegacy, permissions, defaultAudience, applicationId, validateSameFbidAsToken, delegate);
    }
