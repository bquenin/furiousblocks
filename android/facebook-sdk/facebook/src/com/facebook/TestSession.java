...
public class TestSession extends Session {
  ...
  public final String toString() {
    ...
    return new StringBuilder().append("{TestSession").append(" testUserId:").append(testAccountId).append(" ").append(superString).append("}").toString();
  }
  ...
  private void finishAuthWithTestAccount(TestAccount testAccount) {
    ...
    AccessToken accessToken = AccessToken.createFromString(testAccount.getAccessToken(), requestedPermissions, AccessTokenSource.TEST_USER);
